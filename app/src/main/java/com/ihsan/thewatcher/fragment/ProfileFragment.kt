...
import com.ihsan.thewatcher.ChangeEmailActivity
import com.ihsan.thewatcher.CodeScannerActivity
import com.ihsan.thewatcher.LoginActivity
import com.ihsan.thewatcher.R
import com.ihsan.thewatcher.databinding.FragmentProfileBinding
...
class ProfileFragment : Fragment() {
    ...
    private lateinit var cviUser: CircleImageView
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        cviUser = view.findViewById(R.id.cviUser)
                ...
                it.reauthenticate(userCredential).addOnCompleteListener{ task->
                    when{
                        ...
                        task.exception is FirebaseAuthInvalidCredentialsException ->{
                            binding.edtCurrentPassword.error = "Password anda salah!"
                            binding.edtCurrentPassword.requestFocus()
                        }
                        else -> {
